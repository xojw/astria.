document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gamesButton) {
        gamesButton.addEventListener('click', (event) => {
            ...
            const gamesURL = "https://shuttle.lol";
            handleSearch(gamesURL);
        });
    }

    if (nowggButton) {
        nowggButton.addEventListener('click', (event) => {
            event.preventDefault(); 
            const gamesURL = "https://nowgg-x-zhli.onrender.com/";
            handleSearch(gamesURL);
        });
    }
    ...
    if (moviesButton) {
        moviesButton.addEventListener('click', (event) => {
            event.preventDefault(); 
            const gamesURL = "https://streamm4u.com.co";
            handleSearch(gamesURL);
        });
    }
